    ...
    <?php if (isset($estimate) && !empty($estimate)): ?>
        <div class="panel panel-white">
            <div class="panel-heading pt-20 div-main">
                <div class="div-left">
                    <button  type="button" onclick="window.location.href = '<?php echo base_url() . 'estimates' ?>'" class="btn btn-default btn-xs heading-btn btn-back"><i class="icon-arrow-left52 position-left"></i> Back</button>
                </div>
                <div class="<?php echo $center_class ?>">
                    <h6 class="panel-title text-center text-uppercase text-semibold">Estimate Details</h6>
                </div>
                <div class="<?php echo $right_class ?> text-right">
                    <?php if ($edit == 1) { ?>
                        <button  type="button" onclick="window.location.href = '<?php echo base_url() . 'estimates/edit/' . base64_encode($estimate['id']) ?>'" class ="btn btn-default btn-xs heading-btn btn-edit mt-1 mb-1 mt-lg-0 mb-lg-0"><i class="icon-pencil position-left"></i> Edit</button>
                        <button type="button" onclick="window.location.href = '<?php echo base_url() . 'invoices/add?estimate=' . base64_encode($estimate['id']) ?>'" class="btn btn-default btn-xs heading-btn mt-1 mb-1 mt-lg-0 mb-lg-0"><i class="icon-file-check position-left"></i> Copy to Invoice</button>
                    <?php } ?>

                    <!-- <button type="button" onclick="window.location.href = '<?php echo base_url() . 'estimates/print_pdf/' . base64_encode($estimate['id']) ?>'" class="btn btn-default btn-xs heading-btn"><i class="icon-printer position-left"></i> Print</button> -->
                    
                    <a target="_BLANK" class="btn btn-default btn-xs heading-btn mt-1 mb-1 mt-lg-0 mb-lg-0" href="<?php echo base_url() . 'estimates/print_pdf/' . base64_encode($estimate['id']) ?>"><i class="icon-printer position-left"></i> Print</a>

                </div>
            </div>
            <div class="panel-body no-padding-bottom">
                <div class="row">
                    <div class="col-sm-4 col-md-4 col-lg-4 content-group">
                        <?php
                        ...
                        <div tyle="width:100%;display:block;">
                            <span class="text-muted">Estimate To:</span>
                            <ul class="list-condensed list-unstyled">
                    ...
                    <div class="col-sm-8 col-md-8 col-lg-8 content-group">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="invoice-details invoice-detail-right">
                                    <h1 class="text-uppercase text-semibold">Estimate</h1>
                                ...
                                <ul class="list-condensed list-unstyled invoice-payment-details">
                                    <li>
                                        <h5 class="d-flex justify-content-between">
                                            Estimate Date 
                                            <span class="text-right text-semibold"><?php echo date($format['format'], strtotime($estimate['estimate_date'])) ?></span>
                                        </h5>
                                    </li>
                                    <?php
                                        if ($estimate['expiry_date'] != '') {
                                            echo "<li class='text-semibold li_right'>Expiry Date <span>" . date($format['format'], strtotime($estimate['expiry_date'])) . "</span></li>";
                                        }
                                    ?>
                                    <li class='text-semibold li_right'>
                                        Representative
                                        <span><?php echo $estimate['full_name'] ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <tbody>
                            ...
                            foreach ($estimate['parts'] as $k => $p):
                                ...
                                <tr>
                                    ...
                                    <td style="border-bottom:1px solid #ddd;" width="15%"><?php echo $p['location_name']; ?></td>
                                    <td style="border-bottom:1px solid #ddd;" width="35%">
                                        ...
                                        <div class="media-body text-left">
                                            ...
                                            <div class="text-muted text-size-small">
                                                <span class="status-mark border-success position-left"></span> <?php echo $p['description'] ?>
                                            </div>
                                            <?php if($p['item_note'] != "" && $p['item_note'] != null) { ?>
                                                <div class="text-muted text-size-small">
                                                    <span class="status-mark border-primary position-left"></span> 
                                                    <?php echo $p['item_note'] ?>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    </td>
                                    ...
                                    <?php } else { ?>
                                        <td style="border-bottom:1px solid #ddd;" colspan="2">---</td>
                                    <?php } ?>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="content-group">
                            ...
                            <div class="text-right">
                                <button type="button" class="btn btn-primary btn-labeled" onclick="window.location.href = '<?php echo base_url() . 'estimates/send_pdf/' . base64_encode($estimate['id']) ?>'"><b><i class="icon-paperplane"></i></b> Send Estimate</button>
                            </div>
                        </div>
...
<script type="text/javascript" src="assets/js/custom_pages/front/estimates.js"></script>
<style>
    .custom_save_button{
    ...
    .top-estimate-details {width: 100%;}
    .top-estimate-details ul.invoice-payment-details {width: 50%; float: right;}
    .estimate-details {/*width: 90%;*/ max-width: 420px;float: right !important;}

    .invoice-payment-details h5 span{text-align: right;float: left;}
    .invoice-payment-details h5.estimate-label span{float: right !important;}
    .no_parts{
        width: 60%;
    }
    .signature_div {border: 1px solid #e2e2d6;box-shadow: 3px 3px 3px #ededed; width: 100%;}
    ...
    @media screen and (max-width:768px){
        ...
        .panel-heading .div-center h6 {text-align: center !important;margin: 10px 0 !important;}
