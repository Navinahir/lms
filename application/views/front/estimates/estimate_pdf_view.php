        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
          <tr>
            <td align="right" style="padding-top: 10px;">
              <h3  style="font-size: 30px; color: #333333;">Estimate</h3>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
          <tr>
            <td align="left" style="width:50%;vertical-align: bottom;padding-top: 15px;padding-bottom: 10px;">
              <h4 style="font-size: 14px; color: #a7a7aa;">Estimate To:</h4>
            ...
            <td align="right" style="width:50%;vertical-align: text-top;padding-top: 10px;padding-bottom: 10px;">
              <table cellpadding="0" cellspacing="0" border="0" style="width:80%;">
                <tr>
                   <td align="left" style="font-size: 25px; color: #333333;">Estimate</td>
                   <td align="right" style="font-size: 20px; color: #666;"># <?php echo $estimate['estimate_id']; ?></td>
                </tr>
                <tr>
                   <td align="left" style="font-size: 14px; color: #333333;">Estimate Date</td>
                   <td align="right" style="font-size: 13px; color: #666; "><?php echo date($format['format'], strtotime($estimate['estimate_date'])) ?></td>
                </tr>
                <?php if($estimate['expiry_date'] != "" && $estimate['expiry_date'] != "") { ?>
                  <tr>
                     <td align="left" style="font-size: 14px; color: #333333;">Expiry Date</td>
             ...
             <table cellpadding="0" cellspacing="0" width="100%" border="0">
                <tr>
                   ...
                   <td style="font-size: 11px; color: #888;">
                      ...
                      <?php if($p['item_note'] != "" && $p['item_note'] != null) { ?><br><?php echo '("'.$p['item_note'].'")'; ?><?php } ?>
                   </td>
                </tr>
             </table>
          </td>
                  ...
                  <tr>
                    <td width="47%">
                      <!-- <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                          <td colspan="2" style="padding-bottom: 0.5em; font-size: 5em; font-weight: bold">Payment Details</td>
                        </tr>
                        <tr>
                          <td style="font-size: 4em; color: #333; padding: 0.5em 0;">Method</td>
                          <td style="font-size: 4em; color: #666; padding: 0.5em 0;" align="right">Credit Card</td>
                        </tr>
                        <tr>
                          <td style="font-size: 4em; color: #333; padding: 0.5em 0;">Reference</td>
                          <td style="font-size: 4em; color: #666; padding: 0.5em 0;" align="right">POS398473</td>
                        </tr>
                      </table> -->
                    </td>
                    <td width="6%">&nbsp;</td>
