            ...
            <div class="panel panel-white">              
                <div class="panel-body no-padding-bottom">
                    <div class="row">
                        ...
                        <div style="width:100%; text-align: center;display:inline-block; vertical-align:top;">
                            <h2>Report For Gross Sales Form <?php echo $from_date; ?> To <?php echo $to_date; ?></h2>
                        </div>
                    </div>
                </div>
                <?php
                    ...
                    <table class="table table-bordered text-center" style="margin:0 0px;">
                        <thead>
                            <tr>
                                ...
                                <th style="padding: 10px;text-align:center;background-color: #313335;color:#fff;">Customer Name</th>
                                <th style="padding: 10px;text-align:center;background-color: #313335;color:#fff;">Representative</th>
                                <th style="padding: 10px;text-align:center;background-color: #313335;color:#fff;">Gross Sales</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            foreach ($dataArr as $k => $p):
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 10px;"><?php echo $p['cust_name']; ?></td>
                                    <td style="padding: 10px;"><?php echo $p['full_name']; ?></td>
                                    <td style="padding: 10px;"><?php echo $cur . number_format((float) $p['total'], 2, '.', '') ?></td>
                                </tr>
                                <?php
                            endforeach;
                            ?>
                            <tr>
                                <td colspan="5" style="text-align: right;padding:5px"><b>Total Gross Sales</b>&nbsp;&nbsp;</td>
                                <td ><?php echo $cur . number_format((float) array_sum(array_column($dataArr, 'total')), 2, '.','') ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
