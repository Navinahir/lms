            ...
            <div class="panel panel-white">              
                <div class="panel-body no-padding-bottom">
                    <div class="row">
                        ...
                        <div style="width:100%; text-align: center;display:inline-block; vertical-align:top;">
                            <h2>Report For Taxable Service Sales From <?php echo $from_date; ?> To <?php echo $to_date; ?></h2>
                        </div>
                    </div>
                </div>
                <?php
                ...
                <div class="table-responsive">
                    <table class="table table-bordered text-center" style="margin:0 0px;">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td colspan="3" style="text-align: right;padding:5px"><b>Total Taxable Service Sales</b>&nbsp;&nbsp;</td>
