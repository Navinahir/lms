...
<div class="page-header page-header-default">
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active">Sales By Category</li>
        </ul>
    ...
    <div>
                ...
                <div class="panel-body mt-20">
                    <div class="col-md-4">
                        <div class="form-group has-feedback select_form_group">
                            <label class="display-block">Select Category </label>
                            <div class="multi-select-full select-wrap">
                                <select class="multiselect-filtering" multiple="multiple" name="category[]" id="category" style="display:none">
                                    <?php
                                    if (isset($dataArr)) {
        ...
        <div class="row mt-20">
            <div class="col-md-7">
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Sales By Category Graph</h5>
            ...
            <div class="col-md-12">
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Sales By Category Details</h5>
                        <!-- <div class="heading-elements">
                            <ul class="icons-list">
                                <li><a data-action="collapse"></a></li>
                            </ul>
...
?>
<script type="text/javascript" src="assets/js/custom_pages/front/sales_by_category.js?version='<?php echo time();?>'"></script>
<style>
    .dataTables_length{
        margin-right: 20px;
        margin-left: 0px;
