...
<div class="page-header page-header-default">
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active">Labor and Services</li>
        </ul>
    ...
    <div>
            ...
            <div class="panel-body mt-20">
                <div class="col-md-4">
                    <div class="form-group has-feedback select_form_group">
                        <label class="display-block">Select Services </label>
                        <div class="multi-select-full select-wrap">
                            <select class="multiselect-filtering" multiple="multiple" name="services[]" id="services" style="display:none">
                                <?php
                                if (isset($dataArr)) {
                                    foreach ($dataArr as $k => $v) {
                                        ?>
                                        <option class='tools' value="<?php echo $v['id']; ?>"><?php echo $v['name']; ?></option>
                                        <?php
                                    }
                                }
                                ?>
        ...
        <div class="row mt-20">
            <div class="col-md-7">
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Labor and Services Graph</h5>
            ...
            <div class="col-md-12">
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Labor and Services Details</h5>
                        <!-- <div class="heading-elements">
                            <ul class="icons-list">
                                <li><a data-action="collapse"></a></li>
                            </ul>
...
?>
<script type="text/javascript" src="assets/js/custom_pages/front/labor_and_services.js?version='<?php echo time();?>'"></script>
<style>
    .dataTables_length{
        margin-right: 20px;
        margin-left: 0px;
