            ...
            <div class="panel panel-white">              
                <div class="panel-body no-padding-bottom">
                    <div class="row">
                        ...
                        <div style="width:100%; text-align: center;display:inline-block; vertical-align:top;">
                            <h2>Report For Labor and Services</h2>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered text-center" style="margin:0 20px;">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-1 th-center" style="padding: 7px;text-align:center;background-color: #313335;color:#fff;">Service</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="media-body text-left" style="border:none; width:80%;">
                                                        <p class="display-inline-block text-default letter-icon-title" style="color:#313335;"><b>Name: </b><?php echo $p['service_name'] ?></p>
                                                        <div class="text-muted text-size-small"><span class="status-mark border-success position-left"></span><b>Rate: </b><?php echo number_format((float) $p['service_rate'], 2, '.', '') ?></div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
