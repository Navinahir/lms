            ...
            <div class="panel panel-white">              
                <div class="panel-body no-padding-bottom">
                    <div class="row">
                        ...
                        <div style="width:100%; text-align: center;display:inline-block; vertical-align:top;">
                            <h2>Report For Popular Parts</h2>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered text-center" style="margin:0 20px;">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-1 th-center" style="padding: 7px;text-align:center;background-color: #313335;color:#fff;">Parts</th>
                                <th class="col-sm-1 th-center" style="padding: 7px;text-align:center;background-color: #313335;color:#fff;">Total Quantity</th>
                        ...
                        <tbody>
                            ...
                            foreach ($dataArr as $k => $p):
                                ...
                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="media-body text-left" style="border:none; width:80%;">
                                                        <p class="display-inline-block text-default letter-icon-title" style="color:#313335;"><b>Part No: </b><?php
                                                            echo $p['part_no'];
                                                            ?></p>
                                                        <div class="text-muted text-size-small"><span class="status-mark border-success position-left"></span><b>Global Part No: </b><?php echo $p['global_part_no'] ?></div>
                                                        <div class="text-muted text-size-small"><span class="status-mark border-success position-left"></span><b>Vendor: </b><?php echo $p['pref_vendor_name'] ?></div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <td><?php echo $cur . number_format((float) $p['total_amount'], 2, '.', '') ?></td>
                                </tr>
                                <?php
                            endforeach;
                            ?>
