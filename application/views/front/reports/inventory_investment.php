...
<div class="page-header page-header-default">
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active">Inventory Investment</li>
        </ul>
            ...
            <div class="col-md-12">
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Inventory Investment Details</h5>
                    </div>
...
?>
<script type="text/javascript" src="assets/js/custom_pages/front/inventory_investment.js?version='<?php echo time();?>'"></script>
<style>
    .dataTables_length{
        margin-right: 20px;
        margin-left: 0px;
