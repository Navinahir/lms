            ...
            <div class="panel panel-white">              
                <div class="panel-body no-padding-bottom">
                    <div class="row">
                        ...
                        <div style="width:100%; text-align: center;display:inline-block; vertical-align:top;">
                            <h2>Report For Part Costing From <?php echo $from_date; ?> To <?php echo $to_date; ?></h2>
                        </div>
                    </div>
                </div>
                <?php
                    ...
                    <table class="table table-bordered text-center" style="margin:0 0px;">
                        <thead>
                            <tr>
                                ...
                                <th style="padding: 10px;text-align:center;background-color: #313335;color:#fff;">Cost</th>
                                <th style="padding: 10px;text-align:center;background-color: #313335;color:#fff;">Total Cost</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            foreach ($dataArr as $k => $p):
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 10px;"><?php echo $cur . number_format((float) $p['unit_cost'], 2, '.', '') ?></td>
                                    <td style="padding: 10px;"><?php echo $cur . number_format((float) $total_cost, 2, '.', '') ?></td>
                                </tr>
                                <?php
                            endforeach;
                            ?>
                            <tr>
                                <td colspan="3" style="text-align: right;padding:5px"><b>Total Part Costing</b>&nbsp;&nbsp;</td>
                                ...
                                <td><?php echo $cur . number_format((float) array_sum(array_column($dataArr, 'unit_cost')), 2, '.','') ?></td>
                                <td><?php echo $cur . number_format((float) $final_cost, 2, '.','') ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
