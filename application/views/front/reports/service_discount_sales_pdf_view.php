            ...
            <div class="panel panel-white">              
                <div class="panel-body no-padding-bottom">
                    <div class="row">
                        ...
                        <div style="width:100%; text-align: center;display:inline-block; vertical-align:top;">
                            <h2>Report For Service Discount Sales From <?php echo $from_date; ?> To <?php echo $to_date; ?></h2>
                        </div>
                    </div>
                </div>
                <?php
                    ...
                    <table class="table table-bordered text-center" style="margin:0 0px;">
                        <thead>
                            <tr>
                                ...
                                <th style="padding: 10px;text-align:center;background-color: #313335;color:#fff;">Discount Amount</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            ?>
                            <tr>
                                <td colspan="3" style="text-align: right;padding:5px"><b>Total Discount Service Sales</b>&nbsp;&nbsp;</td>
