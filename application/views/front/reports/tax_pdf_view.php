            ...
            <div class="panel panel-white">              
                <div class="panel-body no-padding-bottom">
                    <div class="row">
                        ...
                        <div style="width:100%; text-align: center;display:inline-block; vertical-align:top;">
                            <h2>Report For Collected Tax</h2>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered text-center" style="margin:0 20px;">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-1 th-center" style="padding: 7px;text-align:center;background-color: #313335;color:#fff;">Tax</th>
                                <th class="col-sm-1 th-center" style="padding: 7px;text-align:center;background-color: #313335;color:#fff;">Used Count</th>
                                <th class="col-sm-1 th-center" style="padding: 7px;text-align:center;background-color: #313335;color:#fff;">Total Tax</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            ?>
                            <tr>
                                <td colspan="3" style="text-align: right;padding:5px"><b>Total Tax</b>&nbsp;&nbsp;</td>
