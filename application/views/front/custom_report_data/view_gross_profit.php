...
<div class="page-header page-header-default">
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active">Gross Profit</li>
        </ul>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Invoice Detail</h5>
                ...
                <table class="table datatable-responsive-control-right-invoice">
                    <thead>
                        <tr>
                            <th style="width:5%">#</th>
                            <th>Date</th>
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="3">Total Gross Sales Invoices</th>
                            <th></th>
                            <th></th>
                            <th></th>
                            <th></th>
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Part Costing</h5>
                    <!-- <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                        </ul>
                ...
                <table class="table datatable-responsive-control-right-part">
                    <thead>
                        <tr>
                            <th style="width:5%">#</th>
                            <th>Invoice No</th>
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="3">Total Part Costing</th>
                            <th></th>
                            <th></th>
                            <th></th>
                            <th></th>
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Service Costing</h5>
                    <!-- <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                        </ul>
                ...
                <table class="table datatable-responsive-control-right-service">
                    <thead>
                        <tr>
                            <th style="width:5%">#</th>
                            <th>Invoice No</th>
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="3">Total Service Costing</th>
                            <th></th>
                            <th></th>
                            <th></th>
                            <th></th>
...
<script type="text/javascript" src="assets/js/custom_pages/front/gross_profit.js?version='<?php echo time();?>'"></script>
<style>
    .dataTables_length{
        margin-right: 20px;
        margin-left: 0px;
