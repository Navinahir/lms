        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Part Net Sales</h5>
                ...
                <table class="table datatable-responsive-control-right-net-sale">
                    <thead>
                        <tr>
                            <th style="width:5%">#</th>
                            <th>Date</th>
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="3">Total Net Sales</th>
                            <th></th>
                            <th></th>
                            <th></th>
                            <th></th>
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Service Net Sales</h5>
                    <!-- <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                        </ul>
                ...
                <table class="table datatable-responsive-control-right-net-sale-service">
                    <thead>
                        <tr>
                            <th style="width:5%">#</th>
                            <th>Date</th>
...
<script type="text/javascript" src="assets/js/custom_pages/front/net_sales.js?version='<?php echo time();?>'"></script>
<style>
    .dataTables_length{
        margin-right: 20px;
        margin-left: 0px;
