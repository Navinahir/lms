...
<div class="page-header page-header-default">
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active">Taxable Sales</li>
        </ul>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Taxable Part Sales</h5>
                ...
                <table class="table datatable-responsive-control-right-part">
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="3">Total Taxable Part Sales</th>
                            <th></th>
                            <th></th>
                            <th></th>
                            <th></th>
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Taxable Service Sales</h5>
                    <!-- <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                        </ul>
                ...
                <table class="table datatable-responsive-control-right-service">
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="3">Total Taxable Service Sales</th>
                            <th></th>
                            <th></th>
                            <th></th>
                            <th></th>
...
<script type="text/javascript" src="assets/js/custom_pages/front/taxable_sales.js?version='<?php echo time();?>'"></script>
<style>
    .dataTables_length{
        margin-right: 20px;
        margin-left: 0px;
