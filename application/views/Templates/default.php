                        ...
                        <div class="sidebar-category sidebar-category-visible">
                            <div class="category-content no-padding">
                                <ul class="navigation navigation-main navigation-accordion">
                                    ...
                                    <li class="<?php echo ($class == 'products' && ($action == 'display_products' || $action == 'add_products' || $action == 'edit_products')) ? 'active' : ''; ?>"><a href="<?php echo site_url('admin/products/'); ?>"><i class="icon-box"></i> <span>Products</span></a></li>
