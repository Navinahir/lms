					...
					<div class="row">
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group has-feedback">
										<label class="col-md-12 col-lg-3 lb-w-150 control-label">Assign lead :</label>
										<div class="col-md-12 col-lg-9 input-controlstyle-150">
											<select class="select select-size-sm" id="assign_user_id" name="assign_user_id">
												<?php
												foreach ($assign_sale_person as $k => $v) { ?>
													<option value="<?php echo $v['id']; ?>" <?php if ( isset($dataArr['assign_user_id']) && $dataArr['assign_user_id'] == $v['id']) { echo "selected"; } ?>><?php echo $v['first_name'].' '.$v['last_name']; ?></option>
													<?php
												}
												echo '<label id="assign_user_id_error2" class="validation-error-label" for="assign_user_id">' . form_error('assign_user_id') . '</label>';
												?>
											</select>
										</div>
									</div>
										...
										<div class="col-md-12 col-lg-9 input-controlstyle-150">
											<select class="select select-size-sm" id="state" name="state">
												...
												foreach ($states as $k => $v) { ?>
													<option value="<?php echo $v['id']; ?>" <?php if ( isset($dataArr['state']) && $dataArr['state'] == $v['id']) { echo "selected"; } ?>><?php echo $v['name']; ?></option>
													<?php
												}
												echo '<label id="state_error2" class="validation-error-label" for="state">' . form_error('state') . '</label>';
												?>
											</select>
										</div>
									</div>
