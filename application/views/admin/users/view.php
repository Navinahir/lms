...
<div class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-primary panel-bordered panel-flat view-user-detail-wrap">
                <div class="panel-heading">
                    ...
                    <div class="heading-elements btn_h h-auto">
                ...
                if (isset($dataArr) && !empty($dataArr)):
                    ...
                    <div class="panel-body pt-md-2">
                        ...
                        if (!empty($dataArr['package'])) {
                            ...
                            <div class="col-md-6">
                                <div class="table-responsive">
                                    <table class="table border-blue company-detail mt-0">
                                        <tbody>
                                            <tr class="bg-blue text-center">
        ...
        <?php if($dataArr['package']['no_of_users'] > 1) { ?>
            <div class="col-md-12">
                <div class="panel panel-primary panel-bordered panel-flat view-user-detail-wrap">
                    <div class="panel-heading">
