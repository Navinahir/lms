		...
		<div class="content-detached">
			<div class="row">
				<div class="col-md-12 text-right">
					<a href="<?php echo site_url('admin/product/transponder/add'); ?>" class="btn bg-teal-400 btn-labeled custom_add_button"><b><i class="icon-plus-circle2"></i></b> Add Transponder</a>
				</div>
			</div>
			<br>
									...
									<ul class="list-inline list-inline-condensed heading-text pull-right">
										...
										<li class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-right">
												...
												<li class="divider"></li> -->
												<li><a href="<?php echo site_url('admin/product/transponder/edit/'.base64_encode($v['id'])); ?>"><i class="icon-file-plus"></i> Edit</a></li>
												<li><a href="<?php echo site_url('admin/product/transponder/delete/'.base64_encode($v['id'])); ?>"><i class="icon-cross2"></i> Remove</a></li>
											</ul>
										</li>
									</ul>
								</div>
