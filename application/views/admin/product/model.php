            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div class="bulk_upload_div">
                        ...
                        <form method="post" class="form-validate-jquery" id="bulk_model_form" name="bulk_model_form" action="<?php echo site_url('admin/product/model_bulk_add'); ?>" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
...
<script>
    remoteURL = site_url + "admin/product/Unique_Make_Name";
    <?php if (isset($dataArr)) { ?>
        var model_id = '<?php echo $dataArr['id'] ?>';
        remoteURL = site_url + "admin/product/Unique_Make_Name/" + model_id;
    <?php } ?>
</script>
<script type="text/javascript" src="assets/js/custom_pages/model.js?version='<?php echo time();?>'"></script>

<style>
  @media(min-width:1025px) and (max-width:1300px){
    form#bulk_model_form .col-md-3 {width: 100%;text-align: right;}
    form#bulk_model_form .col-md-9 {width: 100%;}
  }
