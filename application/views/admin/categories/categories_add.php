...
<?php
if (isset($dataArr)) {
    $form_action = site_url('admin/categories/edit/' . base64_encode($dataArr['id']));
} else {
    $form_action = site_url('admin/categories/add');
}
?>
...
<div class="page-header page-header-default">
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo site_url('admin/categories') ?>">Categories Data</a></li>
            <li class="active">
                <?php
                if (isset($dataArr))
                    echo "Edit";
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group has-feedback">
                                        <label class="col-md-12 col-lg-3 control-label lb-w-150 control-label">Categories :</label>
