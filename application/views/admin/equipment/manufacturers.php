...
<div class="content">
    <div class="row">
        ...
        <div class="col-md-5" id="manufacturers_form_row">
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">Manage Manufacturers</h5>
                </div>
                <div class="panel-body">
                    <form method="post" class="form-validate-jquery" id="add_manufacturer_form" name="add_manufacturer_form">
                        <div class="row mt-20">
                            <div class="col-md-12">
                                <div class="form-group form-group-material has-feedback">
                                    <label>Name <font color="red">*</font></label>
                                    <input type="text" class="form-control" name="txt_name" id="txt_name" required="required" placeholder="Enter Name">
                                    <input type="hidden" name="txt_manufacturer_id" id="txt_manufacturer_id">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="bulk_upload_div">
                        ...
                        <form method="post" class="form-validate-jquery" id="bulk_manufacturer_form" name="bulk_manufacturer_form" action="<?php echo site_url('admin/equipments/manufacturer_bulk_add'); ?>" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
        ...
        <div class="col-md-7">
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">List of Manufacturers</h5>
                </div>
...
<script>
    remoteURL = site_url + "admin/equipments/checkUnique_Manufacturer_Name";
<?php if (isset($dataArr)) { ?>
        var m_id = '<?php echo $dataArr['id'] ?>';
        remoteURL = site_url + "admin/equipments/checkUnique_Manufacturer_Name/" + m_id;
<?php } ?>
</script>
<script type="text/javascript" src="assets/js/custom_pages/manufacturer.js"></script>

<style>
  @media(min-width:1025px) and (max-width:1300px){
    form#bulk_manufacturer_form .col-md-3 {width: 100%;text-align: right;}
    form#bulk_manufacturer_form .col-md-9 {width: 100%;}
  }
