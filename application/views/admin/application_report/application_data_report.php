...
<div class="col-md-12">
    <div class="col-md-12 pl-xs-0 pr-xs-0">
        <div class="row mt-20">
            ...
            <div class="col-md-2">
                <div class="form-group has-feedback select_form_group">
                    <button type="button" class="btn bg-teal custom_cancel_button float-none" id="btn_reset">Reset</button>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group has-feedback select_form_group">
                    <select data-placeholder="Filter a Year..." class="select select-size-sm" id="filter_year_name" name="filter_year_name">
                        <option value=""></option>
                    </select>
                </div>
            </div>
                ...
                <table class="table datatable-basic">
                    <thead>
                        <tr>
                            ...
                            <th>Model</th>
                            <th>Year</th>
                            <th>Application Data Completed</th>
                            <th>Parts Attached</th>
                            <th>Tools And Equipment Attached</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                </table>
...
<script type="text/javascript" src="assets/js/custom_pages/application_data_repots.js?version='<?php echo time(); ?>'"></script>
<style>
