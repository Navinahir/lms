<html>
	...
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="nofollow">
	...
	<div class="container">
		<div style="float:right;">
			<p>
				<h4>Messages: <b><span id="msgcount"></span></b></h4>
			</p>
		</div>
		<div class="col-md-3">
		<p>
		...
		$(document).on("click","#send",function() {
			...
			$.ajax({
				...
				success: function(data)
				{
					...
					{
						var socket = io.connect('http://' + window.location.hostname + ':3000',{secure:true,rejectUnauthorized : false });
