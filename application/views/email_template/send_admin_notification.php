<tr>
    <td>
        <p><h2>Hello, ARK Admin</h2></p>
</td>
</tr>
<tr>
    <td style="padding: 0px 0 15px 0;">
        <p>A new account has been requested at your Site.</p>
        <p>To approve users new account, please click on below button:</p>
    </td>
</tr>
<tr>
    <td style="padding:30px;text-align: center">
        <p><a href="<?php echo base_url() . 'admin/users/request'; ?>" class="btn_href">Approve Request</a></p>
    </td>
</tr>
