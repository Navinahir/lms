...
<tr>
    <td style="padding:30px;text-align: center">
        <?php $url = (isset($url) ? $url : 'reset_password') ?>
        <p><a href="<?php echo site_url($url . '?q=' . base64_encode($user_id) . '&code=' . $verification_code); ?>" class="btn_href">Reset your password</a></p>
    </td>
</tr>
<tr>
    <td>
