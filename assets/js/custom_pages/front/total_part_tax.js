...
var table = $('.datatable-responsive-control-right-part').dataTable({
    ...
    ajax: site_url + 'reports/get_total_taxable_part_sales/'+from_date+to_date,
    responsive: {
        details: {
            type: 'column',
            target: -1
...
$(document).on('click', '.part_print', function (e) {
    ...
    var url = updateQueryStringParameter(site_url + 'reports/print_total_taxable_part_sales', "date", date);
