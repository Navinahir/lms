...
var table = $('.datatable-responsive-control-right-part').dataTable({
    ...
    ajax: site_url + 'reports/get_non_taxable_part_sales/'+from_date+to_date,
    responsive: {
        details: {
            type: 'column',
            target: -1
...
var table = $('.datatable-responsive-control-right-service').dataTable({
    ...
    order: [[1, "desc"]],
    lengthMenu: [[10, 20, 30, 50, -1], [10, 20, 30, 50, "All"]],
    ajax: site_url + 'reports/get_non_taxable_service_sales/'+from_date+to_date,
    responsive: {
        details: {
            type: 'column',
            target: -1
...
$(document).on('click', '.part_print', function (e) {
    ...
    var url = updateQueryStringParameter(site_url + 'reports/print_non_taxable_part_sales', "date", date);
...
$(document).on('click', '.service_print', function (e) {
    ...
    var date = from_date+to_date;
    var url = updateQueryStringParameter(site_url + 'reports/print_non_taxable_service_sales', "date", date);
    window.location.href = encodeURI(url);
});
