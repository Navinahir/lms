...
setTimeout(function () {
    ...
    setDataTable(date, category);
    setGraphData(date, category);
}, 500);

function setDataTable(date, category) {
...
//        dom: '<"datatable-header"fl><"datatable-scroll"t><"datatable-footer"ip>',
        ...
        ajax: {
            'type': 'GET',
            "url": site_url + 'reports/get_sales_by_category_data',
            "data": {
                "date": date,
                "category": category
            },
...
function setGraphData(date, category) {
    $.ajax({
        url: site_url + 'reports/get_sales_by_category_graph_data',
        type: "GET",
...
$(document).on('click', '.pdf_button', function (e) {
    ...
    var date = $('#date_range').val();
    var category = $('#category').val();
    var url = updateQueryStringParameter(site_url + 'reports/print_sales_by_category', "date", date);
    if (category != null) {
