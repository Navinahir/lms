...
$('.datatable-basic').dataTable({
    ...
    order: [[1, "asc"]],
    ajax: site_url + 'admin/product/get_transponder',
    responsive: {
        details: {
            type: 'column',
            target: -1
    ...
    columns: [
        ...
        },
        {
            ...
            visible: true,
            render: function (data, type, full, meta) {
                return '<textarea rows="5" style="width:100%;" readonly>'+full.notes+'</textarea>';
            }
        },
        {
            data: "modified_date",
...
if (user_type != 2) {
    var add_button = '<div class="text-right add_action_button"><a href="' + site_url + 'admin/product/transponder/add" class="btn bg-teal-400 btn-labeled custom_add_button  mt-2"><b><i class="icon-plus-circle2"></i></b> Add Data</a></div>';
