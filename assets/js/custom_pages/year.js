...
$(function () {
    $('.datatable-basic').dataTable({
        ...
        order: [[1, "desc"]],
        ajax: site_url + 'admin/product/get_year',
        responsive: {
            details: {
                type: 'column',
                target: -1
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, full, meta) {
                    ...
                    action += '&nbsp;&nbsp;<a href="' + site_url + 'admin/product/year/delete/' + btoa(full.id) + '" class="btn custom_dt_action_button btn-xs" onclick="return confirm_alert(this)" title="Delete">Delete</a>';
                    return action;
                },
                sortable: false,
            },
...
$(document).on('click', '.edit', function () {
    ...
    var url = base_url + 'admin/product/get_year_by_id';
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#txt_year_name").rules("add", {
                remote: site_url + "admin/product/checkUnique_Year_Name/" + data.id,
                messages: {
...
function cancel_click() {
    ...
    $('#txt_year_id').val('');
    $("#txt_year_name").rules("add", {
        remote: site_url + "admin/product/checkUnique_Year_Name/",
        messages: {
            remote: $.validator.format("This year already exist!")
        }
    });
...
var validator = $("#add_year_form").validate({
    ...
    messages: {
        txt_year_name: {
            remote: $.validator.format("This year is already exist!")
        },
        txt_year_name: 'Invalid year.',
    },
