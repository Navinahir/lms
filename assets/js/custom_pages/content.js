...
$('.datatable-basic').dataTable({
    ...
    order: [[0, "desc"]],
    ajax: site_url + 'admin/content/get_contents',
    responsive: {
        details: {
            type: 'column',
            target: -1
    ...
    columns: [
        ...
        },
        {
            ...
            render: function (data, type, full, meta) {
                ...
                action += '&nbsp;&nbsp;<a href="' + site_url + 'admin/content/edit/' + btoa(full.id) + '" class="btn custom_dt_action_button btn-xs" title="Edit">Edit</a>';
                action += '&nbsp;&nbsp;<a href="' + site_url + 'admin/content/delete/' + btoa(full.id) + '" class="btn custom_dt_action_button btn-xs" onclick="return confirm_alert(this)" title="Delete">Delete</a>';
                return action;
            },
            sortable: false,
        },
...
var add_button = '<div class="text-right"><a href="' + site_url + 'admin/content/add" class="btn bg-teal-400 btn-labeled custom_add_button"><b><i class="icon-plus-circle2"></i></b> Add Content</a></div>';
...
var validator = $("#add_content_form").validate({
    ...
    rules: {
        txt_module_name: {required: true, maxlength: 150},
        module_description: {required: true}
    },
...
$(document).on('click', '.content_view_btn', function () {
    ...
    $.ajax({
        url: site_url + 'admin/content/get_content_data_ajax_by_id',
        type: "POST",
        data: {id: this.id},
